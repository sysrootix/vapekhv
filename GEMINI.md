...
Сейчас ты стоимость такси, которое указывает админ - записываешь в колонку "deliveryCost" - это
 неверно, нужно создать новую колонку для информации от админа для каждого заказа